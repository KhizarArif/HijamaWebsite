...
<head>
    ...
    <meta charset="utf-8" />
    <title>Hijama Center Faisalabad </title>
    ...
    <link href="{{ asset('admin_assets/assets/libs/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css') }}"
        ...
        <!-- Date Timer -->
        <link href="{{ asset('admin_assets/assets/libs/bootstrap-datepicker/css/bootstrap-datepicker.min.css')}}" rel="stylesheet">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            </script> © Hijama Center Faisalabad.
                        </div>
                        <div class="col-sm-6">
...
<!-- Mirrored from themesdesign.in/upcube/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 30 Aug 2024 04:50:47 GMT -->
